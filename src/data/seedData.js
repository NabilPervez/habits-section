...
export const ISLAMIC_TASKS = {
  'Fajr': [
    ...
    { title: 'Morning Dhikr', icon: 'book-open', isMandatory: true, durationMinutes: 5, order: 1 },
    ...
    { title: '10 Push-ups', icon: 'dumbbell', isMandatory: false, durationMinutes: 5, order: 4 },
    { title: '10 Squats', icon: 'dumbbell', isMandatory: false, durationMinutes: 5, order: 5 },
    { title: 'Walk 30m', icon: 'person-standing', isMandatory: false, durationMinutes: 30, order: 6 },
    { title: 'Cold Shower', icon: 'droplets', isMandatory: false, durationMinutes: 15, order: 7 },
    { title: 'Face into Ice Water', icon: 'droplets', isMandatory: false, durationMinutes: 5, order: 8 },
    { title: 'Brush Teeth', icon: 'smile', isMandatory: false, durationMinutes: 5, order: 9 },
  ],
  'Dhuhr': [
    ...
    { title: '10 Push-ups', icon: 'dumbbell', isMandatory: false, durationMinutes: 5, order: 3 },
    { title: '10 Squats', icon: 'dumbbell', isMandatory: false, durationMinutes: 5, order: 4 },
    { title: 'Drink Water', icon: 'droplets', isMandatory: false, durationMinutes: 5, order: 5 },
    { title: 'Smile', icon: 'smile', isMandatory: false, durationMinutes: 5, order: 6 },
    { title: 'Box Breathing', icon: 'brain', isMandatory: false, durationMinutes: 5, order: 7 },
  ],
  'Asr': [
    ...
    { title: '10 Push-ups', icon: 'dumbbell', isMandatory: false, durationMinutes: 5, order: 2 },
    { title: '10 Squats', icon: 'dumbbell', isMandatory: false, durationMinutes: 5, order: 3 },
    { title: 'Box Breathing', icon: 'brain', isMandatory: false, durationMinutes: 5, order: 4 },
    { title: 'Drink Water', icon: 'droplets', isMandatory: false, durationMinutes: 5, order: 5 },
  ],
  'Maghrib': [
    ...
    { title: 'Box Breathing', icon: 'brain', isMandatory: false, durationMinutes: 5, order: 3 },
    { title: '10 Push-ups', icon: 'dumbbell', isMandatory: false, durationMinutes: 5, order: 4 },
    { title: '10 Squats', icon: 'dumbbell', isMandatory: false, durationMinutes: 5, order: 5 },
    { title: 'Drink Water', icon: 'droplets', isMandatory: false, durationMinutes: 5, order: 6 },
  ],
  'Isha': [
    { title: 'Pray Isha', icon: 'moon', isMandatory: true, durationMinutes: 10, order: 0 },
    { title: 'Night Dhikr', icon: 'book-open', isMandatory: true, durationMinutes: 5, order: 1 },
    { title: 'Reflect & Journal', icon: 'pencil', isMandatory: false, durationMinutes: 10, order: 2 },
    { title: 'Positive Affirmations', icon: 'smile', isMandatory: false, durationMinutes: 5, order: 3 },
    { title: 'Box Breathing', icon: 'brain', isMandatory: false, durationMinutes: 5, order: 4 },
    { title: 'Prepare for Sleep', icon: 'bed', isMandatory: false, durationMinutes: 5, order: 5 },
    { title: 'Eat Dark Chocolate', icon: 'coffee', isMandatory: false, durationMinutes: 5, order: 6 },
    { title: 'Eat Melatonin', icon: 'moon', isMandatory: false, durationMinutes: 5, order: 7 },
    { title: 'Brush Teeth', icon: 'smile', isMandatory: false, durationMinutes: 5, order: 8 },
    { title: 'Add Water to CPAP', icon: 'droplets', isMandatory: false, durationMinutes: 5, order: 9 },
  ],
};
